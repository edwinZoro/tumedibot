    ...
    <v-app class="d-flex flex-column fill-height">
        <v-app-bar app>
            <v-tabs v-model="tabIndex" background-color="blue accent-3" centered dark icons-and-text>
                ...
                <v-tab :href="`/api/calendario/medico/${medico}/${user}`">
                    Calendario
                ...
                <v-tab :href="'/lista_de_medicos_disponibles_en_tumedibot.com/Super_Buscador'">
                    Buscar Médicos
                    <v-icon>mdi-hospital-box</v-icon>
                </v-tab>
                <v-tab :href="'/lista_de_empresas_de_salud_disponibles_en_tumedibot.com/Super_Buscador_Empresarial'">
                    Empresas de Salud
...
export default {
    ...
    methods: {
        ...
        updateAppointment() {
            fetch(`/api/calendar_doctor/update/${this.eventToUse.id}`, {
                method: 'PATCH',
                mode: 'cors',
                body: JSON.stringify({
