...
class StoreReporteEmpresarial extends FormRequest
{
    /**
    ...
    {
        return [
            'banco_emisor' => 'required|alpha|max:100',
            'banco_receptor' => 'required|alpha|max:100',
            'nmro_referencia' => 'required|numeric|digits_between:4,11',
            'monto_pagado' => 'required|max:100',
            'metodo_transaccion' => 'required|max:100',
            'pedido_id' => 'required|unique:reportes_pagos_clinicas,pedidos_clinicas_id',
            'pedido_total' => 'required'
        ];
    }
