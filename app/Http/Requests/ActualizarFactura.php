...
class ActualizarFactura extends FormRequest
{
    /**
    ...
    public function messages(){
        ...
        'telefono.digits_between' => 'Campo Telefono debe ser min 10 núm y max 11 núm',
        'telefono.numeric' => 'Campo Telefono debe ser numerico (sin puntos, sin comas, sin espacio)',
        'cedula.required' => 'Es Obligatorio llenar campo Cedula',
        'cedula.digits_between' => 'Campo Cédula debe ser min 7 núm y max 8 núm',
        'cedula.numeric' => 'Campo Cédula debe ser numerico (sin puntos, sin comas, sin espacio)',
        ...
        'codigo_postal.digits_between' => 'Campo Código Postal debe ser 4 núm',
        'codigo_postal.numeric' => 'Campo Código Postal debe ser numerico (sin puntos, sin comas, sin espacio)',
