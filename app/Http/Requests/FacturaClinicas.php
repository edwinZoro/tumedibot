...
class FacturaClinicas extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'user_id' => 'unique:facturas_clinicas,user_id',
            'plan' => 'required',
        ];
    }
        ...
        public function messages()
    {
        return [
            ...
            'telefono.digits_between' => 'Campo Telefono Debe agregar entre 10 y 14 números',
            'cedula.required' => 'Campo Cedula es Obligatorio',
            'cedula.numeric' => 'Campo Cedula debe ser numerico (Sin caracteres especiales, sin puntos, sin comas, sin espacio)',
            'cedula.digits_between' => 'Campo Cedula Debe agregar entre 7 y 10 números',
            ...
            'plan.required' => 'Plan es obligatorio',
