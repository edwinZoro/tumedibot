...
class estomago extends Controller
{
  public function estomago_vista(Request $request){
    $array = array($request->estomago1,$request->estomago2,$request->estomago3,$request->estomago4,$request->estomago5,$request->estomago6,$request->estomago7,$request->estomago8,$request->estomago9,$request->estomago10,$request->estomago11,$request->estomago12,$request->estomago13,$request->estomago14,$request->estomago15,$request->estomago16,$request->estomago17,$request->estomago18,$request->estomago19,$request->estomago20,$request->estomago21,$request->estomago22,$request->estomago23,$request->estomago24,$request->estomago25,$request->estomago26,$request->estomago27,$request->estomago28);
    $user= Auth::id();
    ...
    $enfermedades = ['Gastroenteritis','Indigestión','Reflujo Gastroesofágico','Gastroparesia','Úlcera péptica'];
    $enlaces = ['https://www.mayoclinic.org/es-es/diseases-conditions/viral-gastroenteritis/symptoms-causes/syc-20378847','https://www.mayoclinic.org/es-es/diseases-conditions/indigestion/symptoms-causes/syc-20352211','https://www.mayoclinic.org/es-es/diseases-conditions/gerd/symptoms-causes/syc-20361940','https://www.mayoclinic.org/es-es/diseases-conditions/gastroparesis/symptoms-causes/syc-20355787','https://www.mayoclinic.org/es-es/diseases-conditions/peptic-ulcer/symptoms-causes/syc-20354223'];
    ...
    $sintomas_enfermedad_b  = [3,7,8,9,10,11,12,13];
    $sintomas_enfermedad_c  = [7,14,15,16,17];
    $sintomas_enfermedad_d  = [3,9,11,12,10,18];
    $sintomas_enfermedad_e  = [3,7,10,13,19];
    ...
    if(count($vacio)===2) {
      ...
      if (count($sintomas_a) == 2) {
       ...
       return view('organos.estomago_vista',compact('mensaje','enfermedad','especialidades','d','probability','x','enlace','user','ruta'));
     }
     ...
     elseif (count($sintomas_a) == 1) {
       $enfermedad = " {$enfermedades[0]}";$enlace="{$enlaces[0]}";
       return view('organos.estomago_vista',compact('mensaje','enfermedad','especialidades','d','probability_zero','x','enlace','user','ruta'));
   ...
   if(count($vacio)===3) {
    ...
    if( count($sintomas_a) == 3){
     $enfermedad = " {$enfermedades[0]}";$enlace="{$enlaces[0]}";
     return view('organos.estomago_vista',compact('mensaje','enfermedad','especialidades','d','probability_a','x','enlace','user','ruta')); 
   }
 ...
 /*estomago cuatro elecciones 40%(4)*/
 if(count($vacio)===4) {
  $sintomas_a =  [];
  $sintomas_b =  [];
  $sintomas_c =  [];
  ...
  if( count($sintomas_a) == 4){
   $enfermedad = " {$enfermedades[0]}";$enlace="{$enlaces[0]}";
   return view('organos.estomago_vista',compact('mensaje','enfermedad','especialidades','d','probability_b','x','enlace','user','ruta')); 
 }
...
/*estomago cinco elecciones 40%(5)*/
if(count($vacio)===5) {
  $sintomas_a =  [];
  $sintomas_b =  [];
  $sintomas_c =  [];
  ...
  if( count($sintomas_a) == 5){
   $enfermedad = " {$enfermedades[0]}";$enlace="{$enlaces[0]}";
   return view('organos.estomago_vista',compact('mensaje','enfermedad','especialidades','d','probability_c','x','enlace','user','ruta')); 
 }
...
/*estomago cinco elecciones 40%(6)*/
if(count($vacio)===6) {
  $sintomas_a =  [];
  $sintomas_b =  [];
  $sintomas_c =  [];
  ...
  if( count($sintomas_a) == 6){
   $enfermedad = " {$enfermedades[0]}";$enlace="{$enlaces[0]}";
   return view('organos.estomago_vista',compact('mensaje','enfermedad','especialidades','d','probability_d','x','enlace','user','ruta')); 
 }
...
elseif(count($vacio)>=7){
  ...
  $especialidades[2] = '';
  $especialidades[3] = '';
  return view('organos.estomago_vista',compact('mensaje','enfermedad','especialidades','d','x','enlace','user','ruta'));}
  else{
  ...
  public function lista_medico_estomago_medicina_general(Request $request){
    $user =  Auth::id();
  ...
  /*public function lista_medico_estomago_gastroenterologia(Request $request){
    $user =  Auth::id();
    $factura = Factura::where('user_id','=',$user)->get();
    foreach($factura as $f){
        $factu = $f->user_id;
  ...
  public function lista_medico_estomago_medicina_familiar(Request $request){
    $user =  Auth::id();
    $factura = Factura::where('user_id','=',$user)->get();
    foreach($factura as $f){
        $factu = $f->user_id;
  ...
  public function lista_medico_estomago_medicina_interna(Request $request){
    $user =  Auth::id();
    $factura = Factura::where('user_id','=',$user)->get();
    foreach($factura as $f){
        $factu = $f->user_id;
