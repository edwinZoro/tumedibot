...
class vejiga extends Controller
{
     public function vejiga_vista(Request $request){
        $array = array($request->vejiga1,$request->vejiga2,$request->vejiga3,$request->vejiga4,$request->vejiga5,$request->vejiga6,$request->vejiga7,$request->vejiga8,$request->vejiga9,$request->vejiga10,$request->vejiga11,$request->vejiga12,$request->vejiga13,$request->vejiga14,$request->vejiga15,$request->vejiga16,$request->vejiga17,$request->vejiga18,$request->vejiga19,$request->vejiga20,$request->vejiga21,$request->vejiga22,$request->vejiga23,$request->vejiga24,$request->vejiga25,$request->vejiga26,$request->vejiga27,$request->vejiga28);
        $user = Auth::id();
        ...
        $enfermedades = ['Ciscitis intersticial','Infección urinaria','Vejiga hiperactiva','Cáculos en la vejiga'];
        $enlaces =['https://www.mayoclinic.org/es-es/diseases-conditions/interstitial-cystitis/symptoms-causes/syc-20354357','https://www.mayoclinic.org/es-es/diseases-conditions/urinary-tract-infection/symptoms-causes/syc-20353447','https://www.mayoclinic.org/es-es/diseases-conditions/overactive-bladder/symptoms-causes/syc-20355715','https://www.mayoclinic.org/es-es/diseases-conditions/bladder-stones/symptoms-causes/syc-20354339'];
        ...
        $sintomas_enfermedad_c  = [14,15,16,17,18];
        $sintomas_enfermedad_d  = [18,19,20,21,22,23,24,25];
    ...
    return view('organos.vejiga_vista',compact('mensaje','enfermedad','especialidades','d','probability','x','enlace','user','ruta'));
       }
    ...
    return view('organos.vejiga_vista',compact('mensaje','enfermedad','especialidades','d','probability','x','enlace','user','ruta'));
     ...
     elseif (count($sintomas_a) == 1) {
           $enfermedad = " {$enfermedades[0]}";$enlace="{$enlaces[0]}";
    return view('organos.vejiga_vista',compact('mensaje','enfermedad','especialidades','d','probability_zero','x','enlace','user','ruta'));
    ...
    /*vejiga tres elecciones 30%(3)*/
     ...
     $safe_l = in_array($vacio[2], $sintomas_enfermedad_d);
      ...
      if (count($sintomas_a) == 3) {
           $enfermedad = " {$enfermedades[0]}";$enlace="{$enlaces[0]}";
    return view('organos.vejiga_vista',compact('mensaje','enfermedad','especialidades','d','probability_a','x','enlace','user','ruta'));
       }
    ...
    return view('organos.vejiga_vista',compact('mensaje','enfermedad','especialidades','d','probability_zero','x','enlace','user','ruta'));
     ...
     $safe_p = in_array($vacio[3], $sintomas_enfermedad_d);
      ...
      if (count($sintomas_a) == 4) {
           $enfermedad = " {$enfermedades[0]}";$enlace="{$enlaces[0]}";
    return view('organos.vejiga_vista',compact('mensaje','enfermedad','especialidades','d','probability_b','x','enlace','user','ruta'));
       }
    ...
    /*vejiga cinco elecciones 50%(5)*/
     ...
     $safe_t = in_array($vacio[4], $sintomas_enfermedad_d);
      ...
      if (count($sintomas_a) == 5) {
           $enfermedad = " {$enfermedades[0]}";$enlace="{$enlaces[0]}";
    return view('organos.vejiga_vista',compact('mensaje','enfermedad','especialidades','d','probability_c','x','enlace','user','ruta'));
       }
    ...
    return view('organos.vejiga_vista',compact('mensaje','enfermedad','especialidades','d','probability_zero','x','enlace','user','ruta'));
     ...
     $safe_x = in_array($vacio[5], $sintomas_enfermedad_d);
      ...
      if (count($sintomas_a) == 6) {
           $enfermedad = " {$enfermedades[0]}";$enlace="{$enlaces[0]}";
    return view('organos.vejiga_vista',compact('mensaje','enfermedad','especialidades','d','probability_d','x','enlace','user','ruta'));
       }
    ...
    return view('organos.vejiga_vista',compact('mensaje','enfermedad','especialidades','d','probability_zero','x','enlace','user','ruta'));
          ...
          elseif(count($vacio)>=7){
            ...
            $especialidades[2] = '';
            $especialidades[3] = '';
            return view('organos.vejiga_vista',compact('mensaje','enfermedad','especialidades','d','x','enlace','user','ruta'));}
            else{
...
/* public function lista_medico_vejiga_medicina_general(Request $request){
        $user =  Auth::id();
  ...
  public function lista_medico_vejiga_nefrologia(Request $request){
        $user =  Auth::id();
        $factura = Factura::where('user_id','=',$user)->get();
        foreach($factura as $f){
            $factu = $f->user_id;
  ...
  public function lista_medico_vejiga_medicina_familiar(Request $request){
        $user =  Auth::id();
        $factura = Factura::where('user_id','=',$user)->get();
        foreach($factura as $f){
            $factu = $f->user_id;
   ...
   public function lista_medico_vejiga_gastroenterologia(Request $request){
        $user =  Auth::id();
        $factura = Factura::where('user_id','=',$user)->get();
        foreach($factura as $f){
            $factu = $f->user_id;
