...
<head>
  ...
  <link href="{{asset('startbootstrap-freelancer-gh-pages\startbootstrap-freelancer-gh-pages\css\factura_another.css')}}" rel="stylesheet" />
...
<header>
      ...
      <li class="nav-item" id="area_medico">
        ...
        <li >
         ...
         <a class="nav-link text-underline" href="{{route('lista_medico')}}"><i class="bi bi-journal-plus"></i> Buscar Médicos</a>
            ...
            <li class="nav-item">
              <a class="nav-link " href={{route('lista_empresarial')}}><i class="bi bi-building"></i> Clínicas-Laboratorios-Farmacias-Seguros</a>
            </li>
        <li class=" ">
  ...
  <div class="masthead bg">
     <h1 class="text-center text-white fuente_e" id="h1">Reporte de Pagos</h1>
  </div>  
...
<form id="first" class="enviar" action="{{route('reporte_pago_post',$user)}}" method="POST">
@csrf
...
<form id="second" class="enviar" action="{{route('reporte_pago_post',$user)}}" method="POST">
@csrf
<div class="container_c">
    <div class="card_c">
        <div class="form">
...
<form id="tercero" class="enviar" action="{{route('reporte_pago_post',$user)}}" method="POST">
@csrf
<div class="container_c">
    <div class="card_c">
        <div class="form">
