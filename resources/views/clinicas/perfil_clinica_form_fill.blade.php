...
<div>
{!! htmlScriptTagJsApi() !!}
<form  style="border-style:dashed;border-color:skyblue;box-shadow: 2px 2px 13px black" class="card p-2 bg-light needs-validation" method="POST" action="{{route('clinicas_save')}}" enctype="multipart/form-data">
	{{ csrf_field() }}
	@if($errors->any())
...
@endif
	...
	<div class="row">
		<div class="col-md-3 mb-3 w-100">
			...
			<select class="custom-select d-block w-100" type="text" id="tipo_negocio" name="tipo_negocio" value="{{old('tipo_negocio')}}" required>
				<option></option>
		...
		<div class="col-md-3 mb-3">
			...
			<input type="text" class="form-control" name="nombre" id="nombre" value="{{old('nombre')}}" placeholder="Agregue Nombre de Empresa" required>
			<div class="invalid-feedback">
				*Llenar Campo Obligatorio*
			</div>
		</div>
		...
		<div class="col-md-3 mb-3">
			...
			<input type="tel" class="form-control" name="whatsapp" value="{{old('whatsapp')}}" placeholder="Formato de su pais" >
			<div class="invalid-feedback">
				*Llenar Campo Obligatorio*
			</div>
		</div>
	...
	<div class="row">
		<div class="col-md-6 mb-3 w-100">
			...
			<input type="email" class="form-control" name="correo" value="{{old('correo')}}" placeholder="Agregue Correo Empresarial" required>
			<div class="invalid-feedback">
				*Llenar Campo Obligatorio*
			</div>
		</div>
				<div class="col-md-6 mb-3 w-100">
			<label>C&oacute;digo Secreto</label>
	...
	<div class="row">
				...
				<input class="form-control" type="text" name="direccion" value="{{old('direccion')}}" placeholder="Agregue Direccion de Empresa" required>	
				<div class="invalid-feedback">
					*Llenar Campo Obligatorio*
				</div>
			</div >
	...
	<textarea  class="ckeditor" name="perfil_clinica" value="{{old('perfil_clinica')}}" id="perfil_clinica" rows="8" cols="10" minlength="0" maxlength="500" required>
		...
		- No debe ser mayor a 500 caracteres (Aprox 100 palabras).<br>
		- Espacios en blanco cuentan como caracteres. Lo notará si presiona Fuente HTML y observa la siguiente expresión: nbsp;. En su lugar recomendamos borrar esas expresiones y hacer saltos de línea con la etiqueta p de html.<br>
	...
	<div class="row">
		<div class="col-md-12 mb-3">
			...
			<input class="form-control" type="text" name="servicios" value="{{old('servicios')}}" placeholder="Pediatría, Gastroenterología, Odontología, Cirugía, Medicina General, Equipos Médicos,Perfil 20 ..." required>
			<div class="invalid-feedback">
				*Llenar Campo Obligatorio*
			</div>
		</div>
	...
	<div class="row mb-3">
		...
		<div class="col-sm-6">
			<label>Foto 1 para perfil empresarial (Carrousel de im&aacutegenes) <span class="text-danger">*</span></label>
			...
			<ol class="list-group-numbered mt-3">
				...
				<li class="list-group-item-primary">Puede agregar la imágen que desee, sin embargo recomendamos agregar una foto popular de su cuenta de instagram. Ya que encima de esta foto habrá un botón de esta red social. Dicho botón se habilitará automaticamente si llena el campo Instagram con una direcci&oacute;n url</li>
		...
		<div class="col-sm-6">
			<label>Foto 2 para perfil empresarial (Carrousel de im&aacutegenes) <span class="text-danger">*</span></label>
			<div style="text-indent: 15px" id="pesadob"  class="alert-danger  mb-3 ">
				Su imágen pesa más de cinco(5) MegaByte. Reduzca el peso de su imágen para continuar.
			</div>
			<input id="fileb" class="form-control form-custom-file" type="file" name="imagenb" value="{{old('imagenb')}}" accept="image/*" required>     
			<ol class="list-group-numbered mt-3">
				<li class="list-group-item-primary">La imágen 2 es de carácter obligatorio.</li>
				<li class="list-group-item-primary">Puede agregar la imágen que desee, sin embargo recomendamos agregar una foto popular de su cuenta de facebook. Ya que encima de esta foto habrá un botón de esta red social. Dicho botón se habilitará automaticamente si llena el campo Facebook con una direcci&oacute;n url</li>
				<li class="list-group-item-primary">La imágen no debe pesar más de 5 MegaByte ó el sistema la rechazará.</li>
				<li class="list-group-item-primary">Usted puede agregar una imágen de cualquier dimensión de tamaño sin embargo Las Dimensiones de 1920x1281 es la que recomendamos.</li>
				<li class="list-group-item-primary">Considere que dimensiones muy grandes como 3000x3000 pesa más que una de dimensión más pequeña como 1500x1500.</li>
			</ol> 
		...
		<div class="col-sm-6">
			<label>Foto 3 para perfil empresarial (Carrousel de im&aacutegenes) <span class="text-danger">*</span></label>
			<div style="text-indent: 15px" id="pesadoc"  class="alert-danger  mb-3 ">
				Su imágen pesa más de cinco(5) MegaByte. Reduzca el peso de su imágen para continuar.
			</div>
			<input id="filec" class="form-control form-custom-file" type="file" name="imagenc" value="{{old('imagenc')}}" accept="image/*" required>     
			<ol class="list-group-numbered mt-3">
...
{{-- 				<li class="list-unstyled mt-2">
		...
		<div class="col-sm-6">
			...
			<input id="filed" class="form-control form-custom-file" type="file" name="imagend" value="{{old('imagen')}}" accept="image/*" required>     
			<ol class="list-group-numbered mt-3">
		...
		<div class="col-sm-6">
			...
			<input id="filee" class="form-control form-custom-file" type="file" name="imagene" value="{{old('imagenb')}}" accept="image/*" required>     
			<ol class="list-group-numbered mt-3">
		...
		<div class="col-sm-6">
			...
			<input id="filef" class="form-control form-custom-file" type="file" name="imagenf" value="{{old('imagenc')}}" accept="image/*" required>     
			<ol class="list-group-numbered mt-3">
