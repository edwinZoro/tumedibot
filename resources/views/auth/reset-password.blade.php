    ...
    <x-auth-card>
        ...
        <form class="m-3" method="POST" action="{{ route('password.update') }}">
            ...
            <div class="col-sm-12">
                ...
                <x-input id="email" style="border-color: rgba(0,255,0,0.5)" class="form-control" type="email" name="email" :value="old('email', $request->email)" required autofocus />
            </div>
            ...
            <div class="col-sm-12">
                ...
                <x-input id="password" style="border-color: rgba(0,255,0,0.5)" class="form-control" type="password" name="password" required />
            </div>
            ...
            <div class="col-sm-12">
                ...
                <x-input id="password_confirmation" style="border-color: rgba(0,255,0,0.5)" class="form-control"
                                    type="password"
