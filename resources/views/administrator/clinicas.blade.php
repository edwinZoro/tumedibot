...
<head>
    ...
    <meta name="keywords" content="Clínica, Farmacia, Laboratorio, Seguro">
    <meta name="description" content="Encuentra Empresas De Salud">
...
<!-- Copyright Section-->
    ...
    <script>
        Swal.fire({ 
          ...
          text: 'Se ha habilitado en el Área Empresarial 3 Botones: Editar, Ver y Borrar',
